...
export class RemoveUnusedProjectTimelineTypes1591876472332 implements MigrationInterface {
    name = 'RemoveUnusedProjectTimelineTypes1591876472332';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "estimate_timelinetype_enum" AS ENUM('IMMEDIATELY', 'ABOUT_30_DAYS', 'ABOUT_1_TO_3_MONTHS', 'ABOUT_3_TO_6_MONTHS', 'MORE_THAN_6_MONTHS')`, undefined);
        ...
        await queryRunner.query(`CREATE TYPE "project_timelinetype_enum" AS ENUM('IMMEDIATELY', 'ABOUT_30_DAYS', 'ABOUT_1_TO_3_MONTHS', 'ABOUT_3_TO_6_MONTHS', 'MORE_THAN_6_MONTHS')`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "project_timelinetype_enum_old" AS ENUM('IMMEDIATELY', 'ABOUT_30_DAYS', 'ABOUT_1_TO_3_MONTHS', 'ABOUT_3_TO_MONTHS', 'ABOUT_3_TO_6_MONTHS', 'MORE_THEN_6_MONTHS', 'MORE_THAN_6_MONTHS')`, undefined);
        ...
        await queryRunner.query(`CREATE TYPE "estimate_timelinetype_enum_old" AS ENUM('IMMEDIATELY', 'ABOUT_30_DAYS', 'ABOUT_1_TO_3_MONTHS', 'ABOUT_3_TO_MONTHS', 'ABOUT_3_TO_6_MONTHS', 'MORE_THEN_6_MONTHS', 'MORE_THAN_6_MONTHS')`, undefined);
