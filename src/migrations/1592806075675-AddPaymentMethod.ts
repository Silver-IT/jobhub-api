...
export class AddPaymentMethod1592806075675 implements MigrationInterface {
  name = 'AddPaymentMethod1592806075675';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TYPE "milestone_paymentmethod_enum" AS ENUM('BANK', 'CREDIT_CARD', 'CASH')`, undefined);
    await queryRunner.query(`ALTER TABLE "milestone" ADD "paymentMethod" "milestone_paymentmethod_enum"`, undefined);
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "milestone" DROP COLUMN "paymentMethod"`, undefined);
    await queryRunner.query(`DROP TYPE "milestone_paymentmethod_enum"`, undefined);
  }
