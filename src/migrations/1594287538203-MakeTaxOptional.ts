...
export class MakeTaxOptional1594287538203 implements MigrationInterface {
    name = 'MakeTaxOptional1594287538203';

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "final_proposal" ADD "applyTax" boolean NOT NULL DEFAULT true`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "final_proposal" DROP COLUMN "applyTax"`, undefined);
    }
