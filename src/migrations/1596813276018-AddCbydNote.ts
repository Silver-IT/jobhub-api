...
export class AddCbydNote1596813276018 implements MigrationInterface {
    name = 'AddCbydNote1596813276018';

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "project" ADD "governmentCallComment" character varying NOT NULL DEFAULT ''`, undefined);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "project" DROP COLUMN "governmentCallComment"`, undefined);
    }
