...
export function softDeleteFromRepository<T>(payload: any, repository: Repository<T>): Promise<T> {
  return repository.save({...payload, isDeleted: true, deletedAt: new Date().toISOString()})
}
